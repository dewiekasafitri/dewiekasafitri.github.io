...
$nama_dokumen='Laporan Penjualan Toko Rizky'; //Beri nama file PDF hasil.
...
<th width="900px">
<h1>  LAPORAN PENJUALAN  <br> TOKO RIZKY</h1> </br>
...
<table cellspacing="5" cellpadding="5" border="1">
                        ...
                        <tbody>
                        <?php
                        $tampil=mysqli_query($koneksi, "SELECT * FROM penjualan r
                        ...
                        $liatHarga=mysqli_fetch_array(mysqli_query($koneksi, "SELECT sum(total_penjualan) as total_penjualan, 
                      ...
                      ?>
                      <p style="margin: 50px 8px 5px 460px;"> Gempol, <?php echo "$tanggal"?>
                      <br><br></p>
                     <p style="margin: 50px 8px 5px 510px;"> Pemilik Toko </p>
