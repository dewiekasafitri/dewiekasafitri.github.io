...
<!--sidebar start-->
    ...
    <!--main content start-->
        ...
        <section class="wrapper">
          <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-shopping-cart"></i>Transaksi Penjualan</h3>
            <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="dashboard.php">Dashboard</a></li>
              <li><i class="fa fa-shopping-cart"></i>Transaksi Penjualan</li>
            </ol>
          </div>
        </div>
...
<section class="content">
  <div class="row">
    ...
    <a href="?pg=penjualan&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Transaksi </i></button> </a>
    </div><!-- /.box-header -->
              ...
              <div class="box box-info">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                        ...
                        <td align="right"><?php echo "Rp.". number_format("$r[total_penjualan]",'0','.','.')?></td>
                        <td align="right"><?php echo "Rp.". number_format("$r[jumlah_bayar]",'0','.','.')?></td>
                        <td align="right"><?php echo "Rp.". number_format("$r[piutang]",'0','.','.')?></td>
                        <td><center><?php echo "$r[keterangan]"?></center></td>
                        
                        <td><a href="?pg=penjualan&act=edit&id=<?php echo $r['nopenjualan']?>"><center><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></center></a></td>
                        <td><center><a href="?pg=penjualan&act=delete&id=<?php echo $r['nopenjualan']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></center></td>
                        </tr>
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
        ...
        $jml = $_POST[jumlah_bayar];
        $piutang = $total_penjualan - $jml;
        // $piutang = $_POST[total_penjualan] - $_POST[jumlah_bayar];
        ...
        if ($_POST[itemterjual] > $ambilProduk[stokproduk]){
          ...
          <script>window.location='?pg=penjualan&act=add'</script>";
                ...
                $query = mysqli_query($koneksi, "INSERT INTO penjualan VALUES ('$_POST[nopenjualan]','$_POST[tglpenjualan]','$_POST[id_produk]','$_POST[itemterjual]','$total_penjualan','$_POST[jumlah_bayar]','$piutang','$_POST[keterangan]')");
...
<section class="content">
  <div class="row">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select" name="id_produk" style="width: 100%;">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
                  </div><!-- /.box-body -->
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM penjualan WHERE nopenjualan='$_GET[id]'"));
            if (isset($_POST['update'])) {

                mysqli_query($koneksi, "UPDATE penjualan SET tglpenjualan='$_POST[tglpenjualan]',
                  id_produk='$_POST[id_produk]',itemterjual='$_POST[itemterjual]',jumlah_bayar
                  ='$_POST[jumlah_bayar]',keterangan='$_POST[keterangan]','$total_penjualan' WHERE nopenjualan='$_POST[id]'");
...
<div class="content-wrapper">
        ...
        <h1> Transaksi Penjualan </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=penjualan&act=view">Transaksi Penjualan</a></li>
            <li class="active">Update Transaksi Penjualan</li>
             </ol>
        </section>
        <br><br>
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Penjualan</label>
                      <input type="text" class="form-control" id="date" name="tglpenjualan" placeholder="MM/DD/YYY" 
                      required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['tglpenjualan'];?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select" name="id_produk" style="width: 100%;" value= "<?php echo $d['id_produk'];?>">
                      <option value="">Silahkan Pilih</option>
                      <optgroup label="Nama Produk">
                      <?php
                      $tampil=mysqli_query($koneksi, "SELECT * FROM produk ORDER BY id_produk");
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Jumlah Pembelian</label>
                      <input type="number" class="form-control" id="itemterjual" name="itemterjual" placeholder="Jumlah Pembelian" value= "<?php echo $d['itemterjual'];?>">
                    </div>
                      <div class="form-group">
                      <label for="exampleInputEmail1">Jumlah bayar</label>
                      <input type="number" class="form-control" id="jumlah_bayar" name="jumlah_bayar" placeholder="Jumlah Bayar" value= "<?php echo $d['jumlah_bayar'];?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Keteranagn/label>
                      <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keteranagn" value= "<?php echo $d['keterangan'];?>">
                    </div>
                  </div><!-- /.box-body -->
