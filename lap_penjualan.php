...
<div class="content-wrapper">
  <section class="content-header">
        ...
        <section class="content-header">
          <br>
        <h1><b><u>Laporan Penjualan</b></u></h1>
            <ol class="breadcrumb">
  ...
  <div class="col-md-11">
              ...
              <div class="box box-info">
                  ...
                  <table class="table table-hover">
                    ...
                    <td align="right"><span style="font-weight:bold"><?php echo "Rp.$liatHarga[harga],-"?></td>
                    <td align="right"><span style="font-weight:bold"><?php echo "Rp.$liatHarga[isv_sales],-"?></td>
                    </tr>
                    </tbody>
                  </table>
                  </div><!-- /.box-body -->
